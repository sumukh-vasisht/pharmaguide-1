<template>
    ...
    <!-- Top Navbar -->
    <f7-navbar>
      <f7-navbar title="Patients List for Editing" back-link="Back">
    ...
    <f7-list-input
      ...
      ></f7-list-input>
      <f7-list-item :link="'/editPatient/'+patient" v-for="patient in filteredPatients" :title="patient" v-bind:key="patient"></f7-list-item>
    </f7-list>
    <f7-block>        
