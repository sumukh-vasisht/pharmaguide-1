  ...
  <f7-page :name="'Patient '">
    <f7-navbar :title="'Patient - '+ id + ' : Medical History'" back-link="Back">
      ...
      <f7-list>
        ...
        <f7-list-item v-for="(med,index) in medicalHistory.prescription" v-bind:key="index">{{index+1}}<br>Name : {{med.medicineName}}<br>Quantity : {{med.quantity}}<br></f7-list-item>
      </f7-list>
  </f7-page>
</template>
